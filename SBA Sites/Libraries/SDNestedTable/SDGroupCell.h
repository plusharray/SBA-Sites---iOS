...
@property (weak) IBOutlet UITableView *subTable;
@property (weak) IBOutlet SDSubCell *subCell;
@property (nonatomic) int subCellsAmt;
@property (assign) int selectedSubCellsAmt;
@property (nonatomic, weak) NSMutableDictionary *selectableSubCellsState;
@property (weak) NSIndexPath *cellIndexPath;
